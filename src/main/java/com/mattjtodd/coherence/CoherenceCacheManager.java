 ...
 *
 * <p>This implementation uses {@name AtomicReference} and {@name ImmutableMap} for it's
 * implementation</p>
 */
public class CoherenceCacheManager implements CacheManager {
   ...
   */
  private ImmutableMap<String, CoherenceCache> createCache(ImmutableMap<String, CoherenceCache>
                                                               caches, String name) {
